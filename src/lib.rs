...
//! ## Overview
//!
//! `sdcvalidator` provides fast and memory-efficient validation of XML documents
...
//!
//! Unlike traditional validators that reject invalid data, `sdcvalidator` implements
